...
- 105 条 permission deny + 15 条 ask（bash 45+9 / read 30+2 / edit 30+8；灾难线 deny：sudo/rm -rf //git push --force/密钥文件读写；2026-09-05 三轮放宽：解释器 -c/-e 与 docker 全家 allow，.env 读写与 shell rc 改写降 ask）
- OMO 4.19.4
