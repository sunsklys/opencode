...
# 默认 App ID（fork 后可经 FEISHU_APP_ID 环境变量覆盖）
FEISHU_APP_ID="${FEISHU_APP_ID:-cli_aaa482d9dcb8dbcd}"
...
echo "$FEISHU_APP_SECRET" | lark-cli config init --app-id "$FEISHU_APP_ID" --app-secret-stdin
