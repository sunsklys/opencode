...
echo "【4/13】hephaestus GLM 补丁（opencode 缓存版本）"
...
echo "【9/13】plugin @latest 漂移检测（opencode 缓存 vs 项目软链）"
...
echo "【10/13】lark skills SHA256 校验（供应链完整性）"
...
echo "【11/13】oh-my-openagent 内置 skill 软链健康（含自愈）"
...
echo "【12/13】opencode plugin 缓存健康（dist/skills 完整性）"
